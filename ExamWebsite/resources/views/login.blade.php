    ...
    <div class="container border rounded shadow-lg text-light mt-2" style="max-width: 30rem">
        ...
        <form action="login.php?sign={{$isSigning}}" method="POST">
            ...
            <div class="form-group d-inline-flex mw-100 w-100 mt-2">
                ...
                <input type="email" name="email" id="emailBox" class="form-control mx-3" placeholder="Email Address" value="{{$emailAutoFill}}"/>
            </div> 
            <!--Password box-->
            <div class="form-group d-inline-flex mw-100 w-100 mt-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-calendar-date flex-shrink-0 @if(in_array('invalidAge', $status)) text-warning @endif" viewBox="0 0 16 16">
