...
<div class="d-flex flex-column">
    <div class="container border rounded shadow-lg text-light mw-100 mh-100 h-50 w-50 mt-5">
        ...
        <p class="lead text-center" id="loginDesc">Start Learning</p>
        <form action="login.php/?sign={{$isSigning}}" method="POST">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-calendar-date flex-shrink-0 @if(in_array('invalidAge', $status)) text-danger @endif" viewBox="0 0 16 16">
            ...
            <!--Checkboxes-->
            <div class="my-2 mx-5" id="loginIsTeacher">
            ...
            <div class="my-2 mx-5" id="loginIsSigningUp">
